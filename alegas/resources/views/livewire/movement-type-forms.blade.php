...
<!-- update Modal -->
<div wire:ignore.self class="modal fade" id="updateMovementType" tabindex="-1" role="dialog" aria-labelledby="updateMovementTypeModelLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateMovementTypeModelLabel">Editar Tipo de Movimiento</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" wire:click="resetForm">
                    <span aria-hidden="true close-btn">×</span>
                </button>
            </div>
...
<!-- delete Modal -->
<div wire:ignore.self class="modal fade" id="deleteMovementType" tabindex="-1" aria-labelledby="deleteMovementTypeModelLabel"
    aria-hidden="true">
