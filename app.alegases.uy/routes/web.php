...
use App\Http\Livewire\PrintStockByLocationComponent;
...
Route::middleware([
    ...
    Route::get('/imprimir-stock-por-ubicacion/{idLocation}', PrintStockByLocationComponent::class)->name('imprimir-stock-por-ubicacion');
});
